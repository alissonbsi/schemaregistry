...
public class Risk extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static Risk fromByteBuffer(
   ...
   private java.util.List<com.schema.avro.Coverage> coverages;
   ...
   */
  public Risk(java.lang.Long RiskId, java.lang.String RiskDescription, java.util.List<com.schema.avro.Coverage> coverages) {
    this.RiskId = RiskId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: coverages = (java.util.List<com.schema.avro.Coverage>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public java.util.List<com.schema.avro.Coverage> getCoverages() {
    return coverages;
  }
   ...
   */
  public static com.schema.avro.Risk.Builder newBuilder() {
    return new com.schema.avro.Risk.Builder();
  }
   ...
   * @return A new Risk RecordBuilder
   */
  public static com.schema.avro.Risk.Builder newBuilder(com.schema.avro.Risk.Builder other) {
    if (other == null) {
      return new com.schema.avro.Risk.Builder();
    } else {
      return new com.schema.avro.Risk.Builder(other);
    }
  }
   ...
   * @return A new Risk RecordBuilder
   */
  public static com.schema.avro.Risk.Builder newBuilder(com.schema.avro.Risk other) {
    if (other == null) {
      return new com.schema.avro.Risk.Builder();
    } else {
      return new com.schema.avro.Risk.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Risk>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.schema.avro.Risk.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.schema.avro.Risk other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.RiskId)) {
        this.RiskId = data().deepCopy(fields()[0].schema(), other.RiskId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.schema.avro.Risk.Builder setRiskId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.schema.avro.Risk.Builder clearRiskId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.schema.avro.Risk.Builder setRiskDescription(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.schema.avro.Risk.Builder clearRiskDescription() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.schema.avro.Risk.Builder setCoverages(java.util.List<com.schema.avro.Coverage> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.schema.avro.Risk.Builder clearCoverages() {
      coverages = null;
    ...
    public Risk build() {
      try {
        ...
        record.coverages = fieldSetFlags()[2] ? this.coverages : (java.util.List<com.schema.avro.Coverage>) defaultValue(fields()[2]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    long actualSize0 = 0;
    for (com.schema.avro.Coverage e0: this.coverages) {
      actualSize0++;
      out.startItem();
      e0.customEncode(out);
    }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      java.util.List<com.schema.avro.Coverage> a0 = this.coverages;
      if (a0 == null) {
        a0 = new SpecificData.Array<com.schema.avro.Coverage>((int)size0, SCHEMA$.getField("coverages").schema());
        this.coverages = a0;
      } else a0.clear();
      SpecificData.Array<com.schema.avro.Coverage> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<com.schema.avro.Coverage>)a0 : null);
      for ( ; 0 < size0; size0 = in.arrayNext()) {
        for ( ; size0 != 0; size0--) {
          com.schema.avro.Coverage e0 = (ga0 != null ? ga0.peek() : null);
          if (e0 == null) {
            e0 = new com.schema.avro.Coverage();
          }
          e0.customDecode(in);
          a0.add(e0);
        }
