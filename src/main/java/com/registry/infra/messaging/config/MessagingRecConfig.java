...
@Configuration
public class MessagingRecConfig implements MessagingConfigPort<RecordPoc> {
	
	@Autowired
	private KafkaProperties kafkaProperties;

	@Bean(name = "recordproducer")
	@Override
	public KafkaProducer<String, RecordPoc> configureProducer() {
		...
		return new KafkaProducer<String, RecordPoc>(properties);
