...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.registry.avro.Product.Builder newBuilder() {
    return new com.registry.avro.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.registry.avro.Product.Builder newBuilder(com.registry.avro.Product.Builder other) {
    if (other == null) {
      return new com.registry.avro.Product.Builder();
    } else {
      return new com.registry.avro.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.registry.avro.Product.Builder newBuilder(com.registry.avro.Product other) {
    if (other == null) {
      return new com.registry.avro.Product.Builder();
    } else {
      return new com.registry.avro.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.registry.avro.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.registry.avro.Product other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.registry.avro.Product.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.registry.avro.Product.Builder clearName() {
      name = null;
